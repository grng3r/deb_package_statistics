...
package_statistics.py is a python command line tool that takes the
...
program parses the file and outputw the statistics of the top 10
packages that have the most files associated with them.
The following Debian mirror is used: http://ftp.uk.debian.org/debian/dists/stable/main/ .
